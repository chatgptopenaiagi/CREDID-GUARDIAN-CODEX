...
| 40 | Canonical deterministic test command passes. | COMPLETE | 308 tests pass (302 inherited unchanged + six real index-pack interruption tests); exact final commands/output in progress. |
