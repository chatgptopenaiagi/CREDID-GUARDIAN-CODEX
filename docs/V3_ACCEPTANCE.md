...
| 41 | Git publication of CGC V3 itself is verified. | NOT_STARTED | At reconciliation, V3 was uncommitted and live main was still V2. Publication must be verified after checkpoint creation. |
